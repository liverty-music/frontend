 ...
 * @param {Uint8Array} circuit_wasm
 * @param {Uint8Array} circuit_r1cs
 * @param {Uint8Array} proving_key
 * @returns {string}
 */
export function prove(input_json, circuit_wasm, circuit_r1cs, proving_key) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(input_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(circuit_wasm, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(circuit_r1cs, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray8ToWasm0(proving_key, wasm.__wbindgen_malloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('ticketcheck_prover_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
